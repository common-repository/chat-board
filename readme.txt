=== Chat Board ===
Contributors: abojmei
Tags:  Tags: livechat, chat, chatbot, ai, bot
...
This plugin makes use of the following third-party services to enable its functionality:

1. **Chat Board API**: The plugin interacts with the API hosted at `https://dashboard.chatboardapp.com/script/include/api.php`. 
   - This API is responsible for handling chat interactions and synchronizing data with your Chat Board account.
   - [Privacy Policy](https://chatboardapp.com/privacy-policy)
   - [Terms of Use](https://chatboardapp.com/terms-of-service)

2. **JavaScript Initialization**: The plugin includes a JavaScript file from `https://dashboard.chatboardapp.com/account/js/init.js` to load the live chat functionality on your website.
   - This script enables the chat widget to work on your website by connecting to your Chat Board account.

Users should be aware that using this plugin involves interaction with the mentioned services, and data will be sent to these external servers for chat synchronization and functionality.
